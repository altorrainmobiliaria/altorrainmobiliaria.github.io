...
| 🗂️ **Índice sináptico** | `docs/00-INDICE.md` (+ shards `00a`·`00b`·`00c`) | ❌ | Mapa §→línea de `99` + capa semántica síntoma→neurona. Los shards guardan §01-§20, §21-§60 y §66-§90; el kernel los lee como UNO. |
