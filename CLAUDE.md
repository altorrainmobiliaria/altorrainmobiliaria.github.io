...
| 🗂️ **Índice sináptico** | `docs/00-INDICE.md` (+ shards `00a`…`00h`) | ❌ | Mapa §→línea de `99` + capa semántica síntoma→neurona. Los shards guardan la historia ya CERRADA; el kernel los lee como UNO. |
