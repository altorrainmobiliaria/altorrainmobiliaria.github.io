...
| 🧩 **Hojas hijas de `30`** | `docs/31-VERIFICACION-UI.md` · `docs/32-LECCIONES-DOCUMENTALES.md` · `docs/33-LECCIONES-META.md` · `docs/34-DOCTRINA-CODIGO.md` · `docs/35-LECCIONES-PLATAFORMA.md` · `docs/36-LECCIONES-UTILLAJE.md` · `docs/37-META-FUNDACIONALES.md` · `docs/38-GATES-QUE-MIENTEN.md` · `docs/39-ESCRITO-NO-ES-VIGENTE.md` · `docs/33a-LECCION-QUE-NO-DISPARA.md` | ❌ | El nombre dice el tema; lo que no: `32`=`LD-NN` · `33`/`33a`/`37`=`M-NN` (vivas / no dispararon / fundacionales) · `36`= miente la HERRAMIENTA · `38`= miente el ✅ · `39`= escrito ≠ vigente. |
...
- **Áreas**: legacy + `admin.html` + `portal/`. Stack real y reglas de código → `docs/34-DOCTRINA-CODIGO.md`; mapa de archivos → `20`; qué se sirve HOY → `05`.
