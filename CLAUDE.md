...
- **Áreas**: legacy (sus ficheros SIGUEN servidos) + `admin.html` + `portal/`. Stack real y reglas de código → `docs/34-DOCTRINA-CODIGO.md`; mapa de archivos → `20`; qué se sirve HOY → `05`.
