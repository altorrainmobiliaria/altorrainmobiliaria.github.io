...
| 🧩 **Hojas hijas de `30`** | `31-VERIFICACION-UI.md` · `32-LECCIONES-DOCUMENTALES.md` · `33-LECCIONES-META.md` · `34-DOCTRINA-CODIGO.md` · `35-LECCIONES-PLATAFORMA.md` · `36-LECCIONES-UTILLAJE.md` · `37-META-FUNDACIONALES.md` · `38-GATES-QUE-MIENTEN.md` · `39-ESCRITO-NO-ES-VIGENTE.md` | ❌ | El nombre dice el tema; lo que NO dice: `32`=`LD-NN` · `33`=`M-NN` vivas y `37` las fundacionales (dónde falló el cerebro) · `36`= miente la HERRAMIENTA · `38`= miente el ✅ · `39`= el repo dice una cosa y el sistema hace otra. |
...
- **Áreas**: del sitio viejo se retiraron las PÁGINAS, **no los ficheros**: el dominio aún sirve ~3 MB (`js/` · `og/` · `scripts.js`), y ahí vivió la fuga de §250. + `admin.html` + `portal/`. **Stack real y reglas de código → `docs/34-DOCTRINA-CODIGO.md`**; mapa de archivos → `20`.
