---
titulo: 'Cuánto puede subirle el arriendo cada año, y cuál es el techo del canon desde el primer día'
...
portadaAlt: 'Balcones de un edificio de apartamentos en Cartagena a media tarde'
enCorto: 'En un arriendo de vivienda urbana el arrendador puede subir el canon una vez cada doce meses de ejecución del contrato bajo un mismo precio, y el aumento no puede superar el 100 % del incremento del índice de precios al consumidor del año calendario inmediatamente anterior. Lo dice el artículo 20 de la Ley 820 de 2003. Además, el artículo 18 fija un techo al canon mismo: no puede exceder el 1 % del valor comercial del inmueble, y esa estimación comercial no puede pasar de dos veces el avalúo catastral vigente.'
fuentes:
  - titulo: 'Ley 820 de 2003 — arts. 18 (límite del canon) y 20 (reajuste anual)'
...
El artículo 20 de la Ley 820 de 2003 dice que **cada doce meses de ejecución del contrato bajo un mismo precio**, el arrendador puede incrementar el canon **hasta en una proporción que no sea superior al 100 % del incremento que haya tenido el índice de precios al consumidor en el año calendario inmediatamente anterior**.

Conviene leer esa frase despacio, porque tiene tres condiciones metidas en una línea:
...
Ese segundo límite es el que le da dientes al primero. Sin él, bastaría con estimar el inmueble muy alto para justificar cualquier canon. Con él, el techo queda amarrado a una cifra pública que cualquiera puede consultar.

En la práctica este límite muerde poco en zonas donde el avalúo catastral va muy por debajo del mercado, y muerde bastante donde el catastro está actualizado. Vale la pena saber que existe.

## Cómo comprobar su caso, con números

Suponga un canon de **$2.000.000** y un IPC del año anterior del **5,2 %**.

- Aumento máximo: 2.000.000 × 5,2 % = **$104.000**.
- Canon máximo del nuevo periodo: **$2.104.000**.

Si le proponen $2.200.000, le están subiendo el 10 %: el doble del techo legal. Si le proponen $2.050.000, están subiendo por debajo del máximo, lo cual es perfectamente válido.

El cálculo es ése y no tiene truco. Lo único que hay que tener a la mano es el IPC correcto y la fecha del último cambio de canon.
