...
portadaAlt: 'Terraza de un alojamiento en Cartagena con vista al mar'
enCorto: 'El Registro Nacional de Turismo (RNT) es requisito previo y obligatorio para prestar alojamiento turístico, incluidas las viviendas turísticas, y se actualiza cada año: si no se actualiza, la inscripción queda suspendida automáticamente. Además, si el inmueble está sometido a propiedad horizontal, al inscribirse hay que declarar que el reglamento de la copropiedad autoriza ese uso.'
fuentes:
  - titulo: 'Ley 300 de 1996 — Ley General de Turismo (texto compilado con notas de vigencia)'
    entidad: 'DIAN · Normograma'
    url: 'https://normograma.dian.gov.co/dian/compilacion/docs/ley_0300_1996.htm'
  - titulo: 'Ley 2068 de 2020 — reforma a la Ley General de Turismo'
    entidad: 'Función Pública · Gestor Normativo'
    url: 'https://www.funcionpublica.gov.co/eva/gestornormativo/norma.php?i=172558'
  - titulo: 'Decreto 1836 de 2021 — reglamento del RNT, viviendas turísticas y plataformas'
    entidad: 'Función Pública · Gestor Normativo'
...
**Ley 300 de 1996, artículo 61** (modificado por el Decreto Ley 2106 de 2019). El Registro Nacional de Turismo es **requisito previo y obligatorio** para operar. Debe **actualizarse cada año**, y la falta de actualización **suspende automáticamente** la inscripción. Las alcaldías pueden ordenar el **cierre temporal** de los establecimientos que operen sin RNT, y la reactivación exige pagar un salario mínimo legal mensual a FONTUR.

**Artículo 62** (modificado por el mismo decreto). Entre los prestadores de servicios turísticos obligados a inscribirse están los hoteles y demás hospedajes, las **viviendas turísticas** y las **plataformas electrónicas de servicios turísticos**.
...
**Decreto 1074 de 2015, artículo 2.2.4.1.1.11** (según el Decreto 1836 de 2021). Todo prestador debe incluir su **número de RNT en la publicidad** que emita.
...
**Decreto 1074 de 2015, artículo 2.2.4.1.2.2, numeral 8.** Al inscribir una vivienda turística en un inmueble sometido a propiedad horizontal, el prestador **deberá declarar** que las unidades privadas que lo integran **están autorizadas por los reglamentos** para la prestación del servicio de alojamiento turístico.

</div>

La Ley 675 de 2001, que rige la propiedad horizontal, somete el uso de cada unidad privada a la destinación prevista en el reglamento, y permite a la copropiedad sancionar el incumplimiento de las obligaciones no pecuniarias con multas y restricciones al uso de los bienes comunes. El Consejo de Estado negó la demanda de nulidad contra el requisito de autorización expresa y lo mantuvo: quien pretenda ofrecer servicios turísticos en un predio sometido a propiedad horizontal debe contar con que el reglamento se lo permita previamente y de manera expresa.
...
**Ley 300 de 1996, artículos 71 y 72** (modificados por la Ley 2068 de 2020). Son infracciones, entre otras, **operar sin el previo registro**, prestar el servicio sin los requisitos exigidos, la publicidad engañosa y permitir la promoción u oferta de servicios turísticos en lugares donde esté prohibido. Las sanciones las impone la **Superintendencia de Industria y Comercio**: multa, **suspensión del RNT hasta por 30 días** calendario y **cancelación del RNT hasta por 5 años**.
...
**Ley 2068 de 2020, artículo 38.** El operador de una plataforma electrónica de servicios turísticos prestados u ofrecidos en Colombia debe tener **inscripción propia** en el RNT, interoperar con el registro para garantizar que quienes la usan tengan RNT activo, habilitar un espacio donde el prestador exhiba su número, y **no publicar —y retirar— los anuncios de prestadores sin RNT activo y vigente**, o cuando lo pidan las autoridades de inspección, vigilancia y control.
