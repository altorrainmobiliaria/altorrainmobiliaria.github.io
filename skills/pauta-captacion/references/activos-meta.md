...
| **Instagram** | `@altorrainmobiliaria` (asset `102476579273811`) | ✅ en el portafolio · **página↔IG CONECTADO ✅** (`verificado-vivo: 2026-07-18`, settings de la página: cubre contenido, ANUNCIOS, estadísticas, mensajes → **placement IG listo para pauta**) · ⚠️ el "Inicio de sesión necesario" del asset en BM SOLO desbloquea asignar personas/socios/apps (NO es gate de pauta); su OAuth falla hoy con "Sorry, something went wrong" (bug de Meta; el flujo llega hasta "Iniciar sesión como altorrainmobiliaria") · toggle "DMs de IG en bandeja de la página" = OFF (decisión dueño) |
...
1. ~~Login de Instagram~~ **DESESCALADO A OPCIONAL** (07-18): verificado que **página↔IG ya están conectados** y eso cubre anuncios/placement IG → la pauta NO lo necesita. El login del asset en BM (solo asignaciones personas/socios/apps) falla con "Sorry, something went wrong" = bug de Meta (el OAuth sí llega hasta "Iniciar sesión como altorrainmobiliaria"). Reintentar sin prisa: (a) en unos días mismo botón; (b) app Meta Business Suite del teléfono → Configuración; (c) si persiste, permitir cookies de terceros para facebook.com/instagram.com en Chrome.
