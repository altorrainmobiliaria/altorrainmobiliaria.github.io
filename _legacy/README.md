...
| `LECCIONES-MIGRADAS-MAESTRO.md` | — | **No es un monolito destilado**: es el punto de retorno del lote 1 de F2 (2026-09-01). Seis lecciones TRANSFERIBLES (`L-01·L-07·L-08·L-10·L-13·L-14`) se mudaron al cerebro maestro y aquí quedó su **cuerpo íntegro**, para que el ABORT pueda reconstruirlas sin `git checkout`. | `brain-private/maestro/lecciones/migradas/INMO/` (copia consultable) + su titular en `docs/30-LECCIONES` y su stub en `docs/35-LECCIONES-PLATAFORMA` |
