...
| **Portal (staging)** | ✅ **OLA 1 FIDELIDAD COMPLETA Y LIVE** (TODO-27 cerrado, §43-§48): **18 páginas** (8 fieles a mockup + legales + nav; censo → `20`) en `altorra-portal.altorrainmobiliaria.workers.dev` (Astro+Workers, noindex). `verificado-vivo: 2026-08-19` (curl 200 · 135 KB · noindex,nofollow). Go-forward → TODO-30. |
...
- 📣 **HUMO cerrada ✅ · ⚠️ campaña SIN verificar apagado** (§90: el playbook §4b la da ACTIVA y arranca sola al recargar — [[D-15]]; cuenta `1784008112275023` **ACTIVA CON método de pago** y Ads-MCP bloqueado por rollout de Meta, `verificado-vivo: 2026-08-20` ⇒ **solo navegador**): fontanería §4b cerrada (factura con IVA OK). Cifras y benchmarks → `pauta-captacion` §10. Falta de Daniel: ¿los 3 chats eran propietarios reales? Campaña REAL gateada por matrícula + cierre de obra. 
