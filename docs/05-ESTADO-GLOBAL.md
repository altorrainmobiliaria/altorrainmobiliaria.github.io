...
- 📣 **Pauta LISTA-PARA-ENCENDER** (§33-§38): skill `pauta-captacion` + **Meta Business ORDENADO** `verificado-vivo: 2026-07-18` (cuenta ads en el portafolio · píxel `1032884172712946` creado · **WhatsApp CONECTADO + vinculado a página FB ✅ = CTWA listo** · activos → `pauta-captacion/references/activos-meta.md`; pendientes-dueño: login IG · saldo). Encendido converge con cierre de obra. Lotes TikTok → backlog `compartido-marketing/`.
