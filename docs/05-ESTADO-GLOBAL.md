...
| **Kit fundacional** | 📜 **24/24 generan** + gate de emisión verde (§67) · **24/24 AUDITADOS** (§68: 14 lentes + refutación → **191 hallazgos, 25 críticos**) ⚠️ **sin aplicar** = el trabajo abierto, uno a la vez. Crudos → bóveda `2026-07-28-auditoria-kit-b03/`. El manual (15) **ya no se edita a mano**: se ensambla de sus fragmentos. |
