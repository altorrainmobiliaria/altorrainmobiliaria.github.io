...
| **Portal (staging)** | ✅ **OLA 1 FIDELIDAD COMPLETA Y LIVE** (TODO-27 cerrado, §43-§48): las **6 páginas FIELES** al mockup en `altorra-portal.altorrainmobiliaria.workers.dev` (Astro+Workers, noindex). `verificado-vivo: 2026-07-20` (curl 200 + noindex). Go-forward → TODO-30. |
