...
| **Kit fundacional** | 📜 **24/24 generan** + gate de emisión verde (§67) · **24/24 AUDITADOS** (§68: 191 brutos → 57 refutados → **134 vivos**). **🏁 Los 14 CRÍTICOS ya se aplicaron**; quedan 28 altos y 92 leves. Síntesis → bóveda `2026-07-28-auditoria-kit-b03/SINTESIS-CURADA.md`. El manual (15) **ya no se edita a mano**: se ensambla de sus fragmentos. |
