...
- ⚖️ **Matrícula de arrendador OTORGADA** — `Resolución 6636` del 23-jul-2026, papel recibido 2026-08-20 (**pero SIN NÚMERO**: el art. 2º lo deja a "asígnese por el sistema" ⇒ falta la constancia de inscripción. **Ley 820 art. 31 exige ese nº en toda publicidad de arriendo** ⇒ sigue bloqueando el footer del portal (hoy `000000`) y la pauta. ⚠️ El acto cita el establecimiento con matrícula **10011978**, que en `43` es la de la **SOCIEDAD** (el establecimiento sería 10013497) → **aclarar en CC antes de publicar número alguno**. RNT: declarado, sin verificar. Del dueño: la constancia con el nº + **dirección COMERCIAL** (la del acto es el domicilio del representante). Detalle → `43 §Matrícula`.
