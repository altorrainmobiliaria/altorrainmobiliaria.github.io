...
| **Build** | ✅ **MODO OBRA LIVE** `verificado-vivo: 2026-08-26` (curl 200 + sentinela «portal en construcción»): mantenimiento + 66 redirects→home + `.nojekyll` (L-13, §15). El SW legacy = **kill-switch** del modo obra. Sitio viejo RETIRADO; GSC preservado. |
