...
- 📣 **Pauta LISTA-PARA-ENCENDER** (§33-§41): skill `pauta-captacion` + **Meta Business ORDENADO** `verificado-vivo: 2026-07-18` (píxel `1032884172712946` · CTWA listo · IG↔página ✅ · activos → `activos-meta.md`; pendiente-dueño: saldo). **HUMO aprobado pero SIN montar: Ads-MCP aún no habilita la cuenta (re-verificado 2× 07-18) → runbook 10-min en bóveda `2026-07-18-humo/`** (§41). Encendido converge con cierre de obra. Lotes TikTok → backlog.
