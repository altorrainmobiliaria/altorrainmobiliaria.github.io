...
| **Kit fundacional** | 📜 **24/24 generan (13 y 23 RETIRADOS: 22 se firman)** + gate de emisión verde (§67) · **24/24 AUDITADOS** (§68: 191 brutos → 57 refutados → **134 vivos**). **🏁 14 CRÍTICOS + 23 ALTOS aplicados** (§70·§71); quedan **85 leves SIN escéptico** (⚠️ *sin verificar*, no *confirmados*). Síntesis → bóveda `2026-07-28-auditoria-kit-b03/SINTESIS-CURADA.md`. El manual (15) **ya no se edita a mano**: se ensambla de sus fragmentos. |
