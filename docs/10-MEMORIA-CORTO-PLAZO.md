...
| **TODO-48** | 📰 **JOURNAL — PUBLICADO (§147).** 4 artículos REALES con la norma .gov.co citada, índice + artículo + `BlogPosting`, y la banda de la home volvió con el diseño intacto. ⏭️ Falta: **aprobar el mockup** `ALTORRA Journal.dc.html` · llenar «Mercado» y «Guías de zona» con material propio (no relleno) · RE-ENVIAR el sitemap en GSC tras el despliegue. | 🟢 | §147 |
