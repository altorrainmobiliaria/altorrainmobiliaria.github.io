...
| **TODO-17** | **⚡ ARRANQUE OPUS 4.8 — Ola 0 ítem 1** (scaffold `portal/`): protocolo = MEGA-PLAN §4. Pendientes del dueño que NO bloquean: 🔴 razón social/NIT · 🔴 tarifas 2026 · 🔴 dirección GBP · cuenta Cloudflare (Ola 0.2) · respuesta Gemini | 🔮 OPUS | Fable audita al cierre de la ola |
