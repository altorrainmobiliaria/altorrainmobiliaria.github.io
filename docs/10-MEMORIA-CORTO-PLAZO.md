...
> → imágenes WebP ✅ (§24.10) → SERP `/comprar`+`/arrendar` ✅ (§25, mapa esquemático; MapLibre real pendiente) → **ficha (siguiente)** → estancias → publica → precios/landings/panel/rango/aliados/admin.**
