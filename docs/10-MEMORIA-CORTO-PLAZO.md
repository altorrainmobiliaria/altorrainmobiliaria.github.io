...
| **TODO-CEREBRO** | 🧠 **Mantenimiento** (sin pausa desde 20-ago). **TODO-23** kernel: K-01/02/04/05/09 + de §143: el #27 debe resolver el nombre contra la CARPETA del nodo (hoy acepta la mayoría por basename) y los umbrales del #16 ir en COMMITS. K-10 ✅ CERRADO midiendo (§205). **TODO-24** ssotFact de paleta + cache EN EL CUTOVER · ~~**TODO-28** sellos~~ ✅ CERRADO (§206: era el #16, y ya son 30d, no 90) · **TODO-32(b)** [[M-09]] a los hermanos. | 🔄 | §84·§143·§146 |
