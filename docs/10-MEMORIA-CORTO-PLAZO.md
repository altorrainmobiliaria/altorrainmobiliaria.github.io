...
| **TODO-CEREBRO** | 🧠 **Mantenimiento** (sin pausa desde 20-ago). **TODO-23** kernel: K-01/02/04/05/09 + **de §143**: que el #27 resuelva el nombre suelto contra la CARPETA que el nodo ya estableció (hoy lo perdona 92 veces por basename, que es «existe algo así en alguna parte») · que los umbrales del #16 sean en COMMITS, como ya lo es el de auditoría. **TODO-24** ssotFact de paleta + cache EN EL CUTOVER · **TODO-28** #7 sello >90d · **TODO-32(b)** [[M-09]] a los hermanos. 🔬 auditoría Nivel-2 VENCIDA. ⚠️ El banner de costo solo baja con commits de PRODUCTO. | 🔄 | §84·§143 |
...
| **TODO-46** | 📅 **GESTIÓN v1 (ítem 13) — COMPLETA en código.** Expedientes, contratos, pagos, novedades (§112-§118) con sus 5 puertas desplegadas y PROBADAS contra el emulador (§140-§141) · **bóveda de documentos (B5) construida y desplegada** (§142). ⏭️ Falta del mockup: expediente por dentro y visor con bitácora — y **aprobarlo**. ⏭️ Y ESTRENARLA con datos reales (runbook 1.5-1.6). | 🟢 | §142 |
