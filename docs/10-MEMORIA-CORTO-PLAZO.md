...
| **TODO-51** | 🧠⇪ **PROGRAMA CEREBRO MAESTRO** (2-sep): lotes 1-12 SELLADOS por fríos — 194 migradas + 10 G, 19 temas, serie de medianas 5→…→2→2→3. Cola 71 (BERS 18 · **INMO 46** · INSE 7). Corriendo: lote 13 (cierra BERS, abre INMO en `main`). Registro → `../brain-private/cerebro-maestro/BITACORA.md`. | 🔴 Fable+Opus | plan |
