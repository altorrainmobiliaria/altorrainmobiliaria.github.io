...
| **TODO-46** | 📅 **GESTIÓN v1 (ítem 13) — hecha** (§112-§118) y sus **5 puertas de escritura YA DESPLEGADAS** (§140). Sus 3 Functions del paso 1.6 quedan **PROBADAS contra el emulador**, rechazos incluidos (§141). Resta: adjuntos privados (B5) y estrenarla con datos reales. | 🟢 | §141 |
