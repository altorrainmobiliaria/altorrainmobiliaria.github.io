...
| **TODO-34** | ⭐ **FUNDACIÓN OPERATIVA (§61-§64)**. **F1+F2+F4-w1 ✅**: `43-OPERACION` = SSoT (veredictos legales + tarifario sellado) · **KIT FUNDACIONAL de 14 docs LISTO** en bóveda `entregables-fundacion/` (md+docx, auditado 37/37 fixes). **La pelota está en Daniel** → `00-LEEME`: 4 acciones inmediatas (🔴 RUB DIAN vencido · pie Siigo · cuenta escudo · resolución matrícula) + 7 decisiones (% comercial · precio ACM · OK 6 cifras · cancelación hospedaje · aseguradora · SAS vieja · acuerdo socios). **Restos Claude**: % comercial al decidirse · skills F3 (cuando el kit ruede) · cerebro dual Code+Chat. Gates: L-29 · `.gov.co` · dinero/legal = Daniel. | ⏸️ Daniel (LEEME) | §64 · `43` |
