...
| **TODO-16** | **R5**: ✅ **STACK SELLADO** (ADR §16 + `specs/R5-STACK-2026-07.md`: comité ×3 Opus + juez + fallos Fable Q1-Q7) · 🟡 adenda Gemini pendiente (dueño corre `specs/R5-PROMPT-GEMINI-STACK.md`) · ⏳ **MEGA-PLAN por olas** (siguiente) · ⏳ protocolo arranque Opus 4.8 | 🔄 | Fable 91% semanal → dejar todo listo para Opus |
