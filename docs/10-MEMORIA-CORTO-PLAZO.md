...
| **TODO-51** | 🧠⇪ **PROGRAMA CEREBRO MAESTRO** (2-sep): **F2 COMPLETA** (16 lotes, cola 0) + consolidación 2 → 264 migradas + **16 G** = 280 piezas, 23 temas. Corriendo (workflow): dominios → C4-1 medir skills → C6 paquete Chat → F3 piloto (`DICTAMEN-C4-SKILLS` · `PLAN-CIERRE-DOMINIOS-F3-C6`). Luego: decisiones de Fable → C4-2/3 → auditoría de cierre → MEGA-PLAN v2. Registro → `../brain-private/cerebro-maestro/BITACORA.md`. | 🔴 Fable+Opus | plan |
