...
| **TODO-51** | 🧠⇪ **PROGRAMA CEREBRO MAESTRO** (mandato 31-ago): de 4 cerebros a UNO global, recuerdo MECANIZADO, backup restaurable. Plan → `../brain-private/cerebro-maestro/MEGA-PLAN.md`. **F0/F1 ✅**. **F2: NO-GO del comité** (12 mandatos → `../brain-private/cerebro-maestro/DICTAMEN-F2.md`); sigue F0-bis → maestro CON gates → F4. | 🔴 Fable+Opus | plan |
