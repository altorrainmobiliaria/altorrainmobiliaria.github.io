...
| **TODO-48** | 📰 **JOURNAL — PUBLICADO (§147).** 4 artículos REALES con la norma .gov.co citada, índice + artículo + `BlogPosting`, y la banda de la home volvió con el diseño intacto. **5 artículos**; «Guías de zona» estrenada con un HUB que enlaza las 13 landings. ⏭️ Falta: **aprobar el mockup** · «Mercado» sigue vacía (sin dato verificado que citar) · RE-ENVIAR el sitemap en GSC. | 🟢 | §147 |
