...
| **TODO-36** | ⚖️ **Trinquete de boot ×4** (§74·§78): **inmo ✅ 31.5k · cars ✅ 29.7k** (35.9k al empezar) · insema +308c · **bersaglio +7.2k** ← único bloqueante real para subir el `boot-gate` al kernel (su cabecera lo condiciona a que los 3 estén bajo presupuesto; **subir el techo para "cumplir" sería trampa**, M-05). ⚠️ `brain-kit` NO está bajo git: sin historial y fuera de los bundles. | 🟡 bersaglio | §78 |
