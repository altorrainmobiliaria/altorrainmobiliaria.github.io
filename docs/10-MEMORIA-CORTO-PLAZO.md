...
| **TODO-46** | 📅 **GESTIÓN v1** (ítem 13). ✅ agenda (§112) · `crearContrato` con el gate del depósito (§113) · PANTALLA usable (§114). Falta expedientes, pagos, novedades y adjuntos privados (B5). | 🟢 | §114 |
