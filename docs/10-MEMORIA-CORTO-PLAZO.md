...
| **TODO-37** | 🔬 **Hallazgos vivos de la auditoría #6** (tabla → bóveda `2026-08-02-auditoria-cerebro-nivel2-6-inmobiliaria.md`): **11 ABIERTOS** + **18 SIN escéptico** (⚠️ *sin verificar* ≠ *confirmados*; en lote = error del §70.6). **33/44 aplicados** (§83 + lotes 1-5). Anti-engorde: no se retira ningún gate (§83.8). | 🟡 11+18 | §83 |
