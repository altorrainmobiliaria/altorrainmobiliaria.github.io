...
| **TODO-32** | 🧠 **CEREBRO v2 ×4** (§50-§53; versión del kernel → su stamp, no aquí). **(a) ✅ CERRADO §72**. **(b)**: la **poda del router de inmobiliaria ✅ HECHA (§84)** — boot 31.4k→28.4k (99,8%→90,3%) sin subir el techo, con criterio nuevo [[M-09]]. Restan: (i) **llevar M-09 a los hermanos — URGENTE en bersaglio**: medido al propagar el kernel (03-ago) va al **99,9%, 17c de margen** (el próximo cambio de cerebro allí se BLOQUEA) e insema al 98,5%; cars con aire. (ii) el **banner de costo** (57%) que NO baja podando — solo baja con commits de PRODUCTO. | 🔴 (i) bersaglio | §84 |
