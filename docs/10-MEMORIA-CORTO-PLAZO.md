...
| **TODO-39** | 🌊 **OLA 1: faltan 3 de 13** (§90). ✅ SEO técnico (§91) · ✅ 13 landings de zona (§92). Restan: **precios público** · alertas (gateada por el correo roto) · Rango/Rentímetro (necesita rangos de Daniel). ➕ el portal no tiene JSON-LD fuera de `/zona` ni en home/SERP/ficha. | 🟢 construir | MEGA-PLAN §OLA 1 |
