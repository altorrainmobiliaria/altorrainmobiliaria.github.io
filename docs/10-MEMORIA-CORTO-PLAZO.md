...
| **TODO-39** | 🌊 **OLA 1: faltan 2 de 13** (✅ §91 SEO · §92 zonas · §93 precios). Restan: **alertas** (gateada por el correo roto) · **Rango/Rentímetro** (necesita tus rangos). ⚠️ **Tuya (§93.6)**: el footer dice «Avalúo gratis» y B13 lo PROHÍBE (Ley 1673); la voz sí lo usa. ➕ sin JSON-LD fuera de `/zona` y `/precios`. | 🟢 | MEGA-PLAN |
