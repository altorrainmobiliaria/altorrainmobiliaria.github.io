...
| **TODO-22** | **Auditoría Fable**: (a) ✅ §22 auditado (evidencia de HOY) · (b) ✅ **OD-Catálogo = B doc-índice CONDICIONADA** (§54, comité 3/3) — ⏳ adenda Gemini (prompt entregado a Daniel) · implementación = Opus post-TODO-30 (gates G1-G12 en §54). | 🟡 adenda | §54 |
...
| **TODO-31** | 🛡️ **Resiliencia + GC mayor**: (a) ✅ offsite DEFAULT (F0 §50; espejo 2ª cuenta = opcional Daniel) · (b/b2) ✅ canario + guardián bóveda (§49-bis) · (c) ✅ runbook recuperación cuenta GitHub/CF (`50 §Runbook`, guía en cristiano) — ⚠️ falta SOLO que Daniel descargue los recovery codes · (d) ✅ GC de `30` (shard `31-VERIFICACION-UI` + fusión L-04→L-09, 2026-07-23). | 🟡 solo (c) Daniel | §49 · §50 |
...
> (2) ✅ **TODO-31c**: runbook recuperación cuenta GitHub/CF en `50` — ⚠️ Daniel: descargar recovery codes.
...
> (4) ✅ **TODO-22 ejecutado el mismo día** (§54): §22 auditado + OD-Catálogo=B condicionada (comité 3/3) —
> ⏳ Daniel corre el prompt en Antigravity (Gemini 3.1 Pro High) y trae la respuesta → adenda al §54.
