...
| §64 | **TODO-34 F4 wave 1 ✅: KIT FUNDACIONAL — 14 docs redactados (10 redactores) + auditoría adversarial (5 auditores: 37 hallazgos con FIX exacto) + aplicador (37/37) + Word**. En bóveda `entregables-fundacion/` (PRIVADO) con `00-LEEME` (4 acciones inmediatas + 7 decisiones de Daniel). Patrón probado: redactor→auditor→aplicador. ⟦FABLE-5⟧ | 996 |
| §63 | **TODO-34 F2 ✅: verificación legal (6 frentes .gov.co, 45+ claims con cita) + Gemini integrado**. 🔴 RUB vencido ~jul-26 → YA · CE SAGRILAFT DEROGADA 02-jul-26 (citar CE 100-000020 Cap. IX) · 5 prácticas ILEGALES · canon-neto LEGAL con 4 formalidades de mandato · §63.8: SIN contratos vigentes (Daniel) → F4: #0 RUB+tesorería · #1 factura · #2 KIT de arranque · #3 matrícula · #4 societario · #5 datos · #6 corta estancia. ⟦FABLE-5⟧ | 985 |
| §62 | **TODO-34 F1 ✅: triaje del corpus (143 archivos, 9 lectores) + nace `43-OPERACION`**. 6 hallazgos que gobiernan: doble NIT (contratos vivos en la sociedad VIEJA) · matrícula arrendador sin resolución en corpus · Alcaldía rechazó "digital sin local" · gerente sin mayoría · KYC→FONPRECON inservible + sin Política de Datos · tarifario inexistente + cifras en guerra. Bóveda ×4. ⟦FABLE-5⟧ | 975 |
