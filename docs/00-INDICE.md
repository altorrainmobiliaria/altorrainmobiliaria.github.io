...
| §223 | 🛡️ **`verify:huerfanos`**: mecaniza el 222 — resuelve por RUTA (no por nombre, que fallo 2 veces), publica su denominador, congela la deuda de 3 y se cablea en verify Y en el CI (L-56). | 9570 |
| §224 | 🔎 **verify:claims miraba la superficie equivocada**: en la FUENTE la cifra y su etiqueta viven en campos distintos, en el HTML estan juntas. Ahora barre las dos. 15 de 24 hallazgos eran un patron que ya gano. | 9617 |
