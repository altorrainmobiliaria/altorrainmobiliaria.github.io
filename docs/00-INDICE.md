...
| Catálogo (índice denormalizado `indices/*` · `catalogo.get` · `/api/catalogo` · SERP con datos reales) | decisión `99 §54`(+.8) · lectura `§56` · núcleo `§57` · plomería/Functions `§58` · carrera de rebuilds `30 L-35` |
