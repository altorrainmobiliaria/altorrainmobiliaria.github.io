...
| Catálogo (índice denormalizado `indices/*` · `catalogo.get` · `/api/catalogo` · SERP con datos reales) | decisión `99 §54`(+.8) · lectura `99 §56` · núcleo escritura `99 §57` · falta plomería Function (§57.7) |
