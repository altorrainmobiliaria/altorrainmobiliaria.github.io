...
| §150 | ↩️ **Todo el sitio redirigía a su forma CON barra** (307), desde el primer deploy: cadena en los 65 redirects y canonical peleado con el servidor. `drop-trailing-slash` + gate. Paso 5.5 ENSAYADO. | 5595 |
