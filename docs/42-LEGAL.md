...
sola** —una entrada por pregunta cerrada—, así que reventaban un tope que la doctrina estable de
aquí no reventaba. Los **gates por feature** de arriba ya citan su §; si buscas *por qué* se decidió
algo, es allá.
