...
| ¿La mora del MANDATO (doc 03) va a 1,5×IBC o al 6%? | ⏸️ **ABIERTO — decisión de Daniel, no defecto** | `03:287` liquida a **1,5×IBC** (C.Co. 884, acto mercantil) y `04:71` al **6%** (C.C. 1617, vivienda civil); ninguna cláusula cierra la divergencia y `02-TABLA-UNICA:115` solo resuelve el caso comercial | ⛔ No editar el 03 sin la decisión: bajarlo a 6% en un mandato mercantil regala intereses legítimos. Las 5 remisiones (`03:130/227/253/271` + `16-FORMATO:107`) citan la cláusula **por nombre**, así que el cambio sería de UN párrafo. Detalle → bóveda `_notas/BACKLOG-REVISION-KIT.md` **B-05** |
