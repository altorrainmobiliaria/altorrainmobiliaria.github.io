...
⇒ **Migrada al maestro** (F2 lote 13): [[INMO:L-53]] · cuerpo íntegro en `_legacy/LECCIONES-MIGRADAS-MAESTRO.md`.
...
⇒ **Migrada al maestro** (F2 lote 5): [[INMO:L-49]] · cuerpo íntegro en `_legacy/LECCIONES-MIGRADAS-MAESTRO.md`.
